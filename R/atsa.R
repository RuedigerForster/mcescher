...
.correct_outlier_shifts <- function(shifts, ref_sig, test_sig,
  ...
  for (s in outliers) {
    ...
    # re-align within 2.5 using plain Pearson correlation
...
#' @param min_peaks      Minimum number of peaks per segment; segments with
#'                       fewer peaks are merged into a neighbour.
